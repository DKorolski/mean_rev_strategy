        ...
        if not self.position:
            ...
            if long_signal:
                ...
                o1 = self.buy(exectype=bt.Order.Market,
                              ...
                              valid=valid,
                              transmit=False)
                self.log(f"{self.data.datetime.date(0)}: Oref {o1.ref} / Buy Market at {p1:.2f} (Size {pos_size})")
                ...
                o1 = self.sell(exectype=bt.Order.Market,
                               ...
                               valid=valid,
                               transmit=False)
                self.log(f"{self.data.datetime.date(0)}: Oref {o1.ref} / Sell Market at {p1:.2f} (Size {pos_size})")
...
if __name__ == '__main__':
    ...
    config["strategy"]["exit_offset"] = datetime.timedelta(minutes=config["strategy"]["exit_offset"])
